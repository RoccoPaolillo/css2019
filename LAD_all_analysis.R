...
# SHAPE files
bradford <- readOGR(dsn = "LAD_shp_NetLogo/Bradford/", layer = "Bradford", stringsAsFactors=F)
...
frml1_csegr <- as.formula(paste("segrlsoa_simpson2_ethgrouped_11 ~", predictor_str, "+ segrlsoa_simpson2_ethgrouped"))
frml2_csegr <- as.formula(paste("segrlsoa_fraction_ethgrouped_asian_11 ~", predictor_str, " + segrlsoa_fraction_ethgrouped_asian"))
frml4_csegr <- as.formula(paste("segrlsoa_fraction_ethgrouped_whiteb_11 ~", predictor_str, "+ segrlsoa_fraction_ethgrouped_whiteb"))
frml4 <- as.formula(paste("segrlsoa_fraction_ethgrouped_whiteb_11 ~", predictor_str))
...
lm.mod1_csegr <- lm(formula=frml1_csegr, data=bradford@data)
...
lm.mod2_csegr <- lm(formula=frml2_csegr, data=bradford@data)
...
lm.mod4_csegr <- lm(formula=frml4_csegr, data=bradford@data)
...
lagsarlm.mod1_csegr <- lagsarlm(formula=frml1_csegr, data=bradford@data, listw = W.list_bradford)
...
lagsarlm.mod2_csegr <- lagsarlm(formula=frml2_csegr, data=bradford@data, listw = W.list_bradford)
...
moran1_csegr <- moran.mc(x=resid.lm.mod1_csegr, listw=W.list_bradford, nsim=10000)
moran2_csegr <- moran.mc(x=resid.lm.mod2_csegr, listw=W.list_bradford, nsim=10000)
moran4_csegr <- moran.mc(x=resid.lm.mod4_csegr, listw=W.list_bradford, nsim=10000)
...
moran1_csegr.test <- moran.test(x=resid.lm.mod1_csegr, listw=W.list_bradford)
moran2_csegr.test <- moran.test(x=resid.lm.mod2_csegr, listw=W.list_bradford)
moran4_csegr.test <- moran.test(x=resid.lm.mod4_csegr, listw=W.list_bradford)
...
spmoran1_csegr <- moran.mc(x=resid.lagsarlm.mod1_csegr, listw=W.list_bradford, nsim=10000)
spmoran2_csegr <- moran.mc(x=resid.lagsarlm.mod2_csegr, listw=W.list_bradford, nsim=10000)
spmoran4_csegr <- moran.mc(x=resid.lagsarlm.mod4_csegr, listw=W.list_bradford, nsim=10000)
...
spmoran1_csegr.test <- moran.test(x=resid.lagsarlm.mod1_csegr, listw=W.list_bradford)
spmoran2_csegr.test <- moran.test(x=resid.lagsarlm.mod2_csegr, listw=W.list_bradford)
spmoran4_csegr.test <- moran.test(x=resid.lagsarlm.mod4_csegr, listw=W.list_bradford)
...
moransI_ch <-  data.frame(
  ...
  p_value=c(moran1_ch$p.value, 
            moran2_ch$p.value, 
            moran4_ch$p.value))
moransI_csegr <-  data.frame(
  index=c("Local Simpson","Fraction Asians", "Fraction White British"),
  statistic=c(moran1_csegr$statistic, 
              moran2_csegr$statistic, 
              moran4_csegr$statistic),
  p_value=c(moran1_ch$p.value, 
            moran2_ch$p.value, 
            moran4_ch$p.value))
...
spmoransI_ch <-  data.frame(
  ...
  p_value=c(spmoran1_ch$p.value, 
            spmoran2_ch$p.value, 
            spmoran4_ch$p.value))
spmoransI_csegr <-  data.frame(
  index=c("Local Simpson","Fraction Asians", "Fraction White British"),
  statistic=c(spmoran1_csegr$statistic, 
              spmoran2_csegr$statistic, 
              spmoran4_csegr$statistic),
  p_value=c(spmoran1_ch$p.value, 
            spmoran2_ch$p.value, 
            spmoran4_ch$p.value))
...
save(lm.mod1, lm.mod2, lm.mod4, lm.mod1_ch, lm.mod2_ch, lm.mod4_ch, lm.mod1_csegr, lm.mod2_csegr, lm.mod4_csegr, 
     lagsarlm.mod1, lagsarlm.mod2, lagsarlm.mod4, lagsarlm.mod1_ch, lagsarlm.mod2_ch, lagsarlm.mod4_ch,
     lagsarlm.mod1_csegr, lagsarlm.mod2_csegr, lagsarlm.mod4_csegr,
     moransI, moransI_ch, moransI_csegr, spmoransI, spmoransI_ch, spmoransI_csegr, file = "R/modeloutput")
load("R/modeloutput")
...
moransI_ch
print(summary(lm.mod1_csegr), signif.stars = TRUE)
print(summary(lm.mod2_csegr), signif.stars = TRUE)
print(summary(lm.mod4_csegr), signif.stars = TRUE)
moransI_csegr
...
spmoransI_ch
print(summary(lagsarlm.mod1_csegr), signif.stars = TRUE)
print(summary(lagsarlm.mod2_csegr), signif.stars = TRUE)
print(summary(lagsarlm.mod4_csegr), signif.stars = TRUE)
spmoransI_csegr
